...
| v0.2.1 | Planner evaluation suite — 32 eval cases, offline harness |
...
| v0.3.3 | Telnyx SMS provider — second channel adapter, POST /telnyx/sms, outbound via /v2/messages |

---

## 4. Current Verified State

- v0.3.3 committed and pushed to `main`.
